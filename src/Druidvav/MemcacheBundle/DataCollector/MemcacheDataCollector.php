<?php
namespace Druidvav\MemcacheBundle\DataCollector;

use Druidvav\MemcacheBundle\Memcache\LoggedClient;
...
class MemcacheDataCollector extends DataCollector
{
     ...
     * @param LoggedClient             $memcache Logging Memcache object
     *
     * @return void
     */
    public function addClient($name, $options, LoggedClient $memcache)
    {
